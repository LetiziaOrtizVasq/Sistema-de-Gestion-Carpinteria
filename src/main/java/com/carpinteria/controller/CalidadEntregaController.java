...
import com.carpinteria.service.CalidadEntregaService;
...
public class CalidadEntregaController {
    ...
    @GetMapping("/calidad/eliminar/{id}")
    ...
    @GetMapping("/embalaje/eliminar/{id}")
    ...
    @PostMapping("/pagos-final/guardar")
    ...
    @GetMapping("/pagos-final/eliminar/{id}")
